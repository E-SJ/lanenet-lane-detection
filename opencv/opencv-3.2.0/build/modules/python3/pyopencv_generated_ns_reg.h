...
static PyMethodDef methods_dnn[] = {
    ...
    {"DeconvolutionLayer_create", (PyCFunction)pyopencv_cv_dnn_DeconvolutionLayer_create, METH_VARARGS | METH_KEYWORDS, "DeconvolutionLayer_create([, kernel[, stride[, pad[, dilation]]]]) -> retval"},
